# 전서기 AI 서비스 개발자 포트폴리오

신입 AI 서비스 개발자 지원용 단일 페이지 포트폴리오 사이트입니다.

이 사이트는 단순 자기소개보다 채용 담당자가 바로 확인할 수 있는 배포 링크, 실제 화면, 구현 범위, 한계 사항을 앞에 배치합니다.
...
- 첫 화면: AI 서비스 개발자 포지셔닝, 대표 데모 CTA, 배포/QA 증빙
- 대표 프로젝트: AI Portfolio Lab, ConsultFlow, FairSign, K-Transit
- 보조 프로젝트: Fishing Helper, Media Node Studio, VoxCPM Local, Excel Automation Pro
- 역량 정리: RAG, LLM 평가, AI CS, AI 콘텐츠, 업무 자동화
