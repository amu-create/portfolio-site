...
import { Brain, Shield, Link, Play, Github, BarChart3, Users, Cpu } from 'lucide-react';
...
const aimlProjects = [
  {
    ...
    videoUrl: "https://www.youtube.com/embed/baJXYFqhmGc",
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/fmlhbJH3Vrc",
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/DW9xuorMC08",
                  ...
                  <div className="relative rounded-xl overflow-hidden shadow-2xl">
                    ...
                    {isVideoPlaying[project.id] ? (
                      ...
                      <div className="relative aspect-video cursor-pointer"
                           onClick={() => setIsVideoPlaying({ ...isVideoPlaying, [project.id]: true })}>
                        <Image
